...
experiment's circuits, most journal cases and public-audit cases have pool
coverage; receiver current-unspent and replay semantics still need mapping, as
