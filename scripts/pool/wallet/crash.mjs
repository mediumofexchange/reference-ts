...
try {
  for (const operation of ['request', 'pending', 'receipt', 'fulfillment']) {
  ...
  console.log('Pool wallet crash check passed: eight abrupt exits and eight fresh-process recoveries.');
} finally {
