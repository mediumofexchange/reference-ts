...
try {
  for (const operation of ['request', 'pending', 'receipt', 'fulfillment', 'capability', 'inbox']) {
  ...
  console.log('Pool wallet crash check passed: twelve abrupt exits and twelve fresh-process recoveries.');
} finally {
