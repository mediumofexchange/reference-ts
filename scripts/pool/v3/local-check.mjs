...
try {
  ...
  const intrinsicPairs = [...imported.intrinsicCases, ...silent.intrinsicCases, ...scoped.intrinsicCases, ...scopeRecovery.intrinsicCases];
  await test("compact shared-scope clocks, predecessor refusal and repair agree in portable packages", async () => {
